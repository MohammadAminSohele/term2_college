...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nat_code', models.CharField(max_length=10, verbose_name="Student's national code")),
                ...
                ('mobile', models.CharField(max_length=11, validators=[django.core.validators.RegexValidator(message='Invalid phone number.', regex='^09\\d{2}\\s*?\\d{3}\\s*?\\d{4}$')], verbose_name='Phone number')),
                ('regdate', models.DateField(verbose_name='Date of Registration')),
                ('description', models.TextField(verbose_name='Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nat_code', models.CharField(max_length=10, verbose_name="Teacher's national code")),
                ('birthday_date', models.DateField(verbose_name='Date of birth')),
                ('telephone', models.CharField(max_length=11, verbose_name='landline number')),
